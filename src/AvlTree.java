...
/***********************************************************************************************************************
 * @file: AvlTree.java
 * @description: This program implements a generic AVL tree.
...
public class AvlTree<AnyType extends Comparable<? super AnyType>> {
	...
	// FINISH ME
        ...
        if (t.element.compareTo(x) > 0) {
            ...
            t.left = remove(temp.element, t.left); // since temp is the max element in the left subtree it deletes it
        }
        return balance(t);
    }
	...
	// FINISH ME
        ...
        else if (t.element.compareTo(x) == 0) { // Found the node
            return true;
        }
        else {
